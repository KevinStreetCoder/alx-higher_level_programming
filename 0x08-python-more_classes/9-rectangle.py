...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Compares two rectangles and returns the one with the bigger area or the first one in case of a tie.

        Args:
            rect_1 (Rectangle): The first rectangle to compare.
            rect_2 (Rectangle): The second rectangle to compare.
        Returns:
            Rectangle: The rectangle with the bigger area or rect_1 in case of a tie.
        Raises:
    ...
    def square(cls, size=0):
        ...
        Returns:
            Rectangle: A new rectangle object with equal width and height.
        """
